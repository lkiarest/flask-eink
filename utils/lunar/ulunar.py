...
import time
from utils.lunar.lunar_data import _lunar_data
from utils.lunar.qw_icons import *
...
class Lunar():
    def __init__(self, year, month, day):
        ...
        @param day, 日期
        '''
        tm_now = (year, month, day, 0, 0, 0, 0, 0, 0)
        ...
        offset = int((now - start) // (60 * 60 * 24) * 5)
    ...
    def getZodiacIcon(self):
        '''获取生肖图像信息'''
        return zodiac_icon_fill[self.dizhi]
